...
1. Run `uv run python -m skilllint.plugin_validator check /home/ubuntulinuxqa2/repos/claude-plugins-official` and capture stdout + exit code
2. Run `uv run python -m skilllint.plugin_validator check /home/ubuntulinuxqa2/repos/skills` and capture stdout + exit code
3. Run `uv run python -m skilllint.plugin_validator check /home/ubuntulinuxqa2/repos/claude-code-plugins` and capture stdout + exit code
...
- External repos at `/home/ubuntulinuxqa2/repos/claude-plugins-official`, `/home/ubuntulinuxqa2/repos/skills`, `/home/ubuntulinuxqa2/repos/claude-code-plugins`
