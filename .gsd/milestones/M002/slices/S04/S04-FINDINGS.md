...
uv run python -m skilllint.plugin_validator check /home/ubuntulinuxqa2/repos/claude-plugins-official --no-color; echo "exit: $?"
# Expected: exit 1 (due to FM003/FM005 errors)

uv run python -m skilllint.plugin_validator check /home/ubuntulinuxqa2/repos/skills --no-color; echo "exit: $?"
