...
ls -la ~/repos/claude-plugins-official
ls -la ~/repos/skills
ls -la ~/repos/claude-code-plugins
```
...
1. Run: `uv run python -m skilllint.plugin_validator check ~/repos/claude-plugins-official --no-color`
...
1. Run: `uv run python -m skilllint.plugin_validator check ~/repos/skills --no-color`
...
1. Run: `uv run python -m skilllint.plugin_validator check ~/repos/claude-code-plugins --no-color; echo "exit: $?"`
