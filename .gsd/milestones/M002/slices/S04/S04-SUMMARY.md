...
uv run python -m skilllint.plugin_validator check /home/ubuntulinuxqa2/repos/claude-plugins-official; echo "exit: $?"
# exit: 1 (due to FM003/FM005 genuine errors)

uv run python -m skilllint.plugin_validator check /home/ubuntulinuxqa2/repos/skills; echo "exit: $?"
# exit: 1 (due to FM003 genuine errors)

uv run python -m skilllint.plugin_validator check /home/ubuntulinuxqa2/repos/claude-code-plugins; echo "exit: $?"
