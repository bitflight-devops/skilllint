...
| AG001–AG003 | Agent frontmatter | `agents/*.md` (any scope) conformance with Claude Code's sub-agents.md: `tools` resolves to no tool, MCP server casing, `skills` YAML-list shape |
